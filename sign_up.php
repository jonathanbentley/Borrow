                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td valign="top" class="textContent">
                                                                        <img src="cid:logo_2u" alt="" style="float: center; max-width: 100%;">
                                                                        <br><b>[borrow]</b> was created to connect people wanting to share their items, equipment or skills with those in their area looking to rent these goods.</br>
																		<br>In every household, countless items sit stagnantly in storage, waiting for you to find a use for them. Our platform allows you to list these items on a local board for people in your community to see. People can then request to rent your items for a flat daily fee. The customers rate your items, while you rate the customers. [borrow] is the first peer-to-peer rental platform allowing anyone to rent any of their posessions.</br>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <!-- // CONTENT TABLE -->
                                                            ...
                                                            <table align="Left" border="0" cellpadding="0" cellspacing="0" width="260" class="flexibleContainer">
                                                                <tr>
                                                                    <td valign="top" class="textContent">
                                                                        <h3>Buyers</h3>
                                                                        <br />
                                                                        Brows from hundreds of local items available for rent. From lawnmowers to tools to boardgames, find whatever you are looking for on Borrow. All buyers are protected by our buyer protection program--if the item is not exactly as described on our website you get your money back. Guaranteed.
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <!-- // CONTENT TABLE -->
                                                            ...
                                                            <table align="Right" border="0" cellpadding="0" cellspacing="0" width="260" class="flexibleContainer">
                                                                <tr>
                                                                    <td valign="top" class="textContentLast">
                                                                        <h3>Sellers</h3>
                                                                        <br />
                                                                        Become a seller on Borrow in just two easy steps. Create an account, then list your items for rent. It's as simple as that. Start making money off of your unused items today.
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <!-- // CONTENT TABLE -->
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="260" class="emailButton">
                                                                <tr>
                                                                    <td align="center" valign="middle" class="buttonContent">
                                                                        <a href="http://localhost/app/signup.html" target="_blank">Start Borrowing!</a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <!-- // CONTENT TABLE -->
...
if ($unique) {
	...
	$mail = new PHPMailer ();
	$mail->AddEmbeddedImage('images/logoBlack.png', 'logo_2u');
