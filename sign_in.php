...
<body>
	...
	<div class="w3-top" style="z-index: 999">
		<ul class="w3-navbar w3-white w3-card-2 w3-left-align">
			...
			<li class="w3-hide-small"><a href="sign_in.html"
				class=" w3-padding-large">sign in</a></li>
		</ul>
	</div>
						...
						<div id="login">
							<form id='login' action='login.php' method='post'
								...
								<fieldset>
									...
									<div style="padding-top: 5ex">
										<button type="submit" class="button special" name="submit">Login</button>
									</div>
								</fieldset>
							</form>
						</div>
